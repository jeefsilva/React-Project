...
class ExpandCardPlan extends React.Component {
            ...
            <Grid container className={classes.grid} justify='space-between'>
                <Card className={`${'flex-column-center'} ${classes.card}`} elevation={2}>
                    ...
                    <ExpansionPanel className={`${'panel-plans'} ${classes.panel}`} elevation={0} onChange={(event: any, expanded: boolean) => {
                        ...
                        // @ts-ignore
                        expandedStates.meiToME = expanded;
                        this.setState(this.state);
                    }}>
                        <ExpansionPanelSummary className={classes.panelSummary}>
                            <Grid container justify='center'>
                                <Icon className={`${classes.iconExpand} ${expandedStates.meiToME ? classes.expandedIcon : undefined}`}>
                                    {expandedStates.meiToME ? 'keyboard_arrow_up' : 'keyboard_arrow_down'}
                                </Icon>
                            </Grid>
                        ...
                        <ExpansionPanelDetails className={classes.panelDetails}>
                            <Grid container justify='center'>
                                ...
                                <Typography variant='body2' className={classes.cardIndicatedText}>
                                    Profissionais que estão como MEI, e <br/> estão prestes a estourar o limite anual <br/>
                                    de faturamento, ou que precisam <br/> exercer alguma atividade impeditiva no <br/> MEI
                                </Typography>
                                <div className={classes.linkButton}>
                                    <Link href={'/cadastro?refer=Migrar de MEI para ME - Card - Pagina de Planos'} color='inherit'
                ...
                <Card className={`${'flex-column-center'} ${classes.card}`} elevation={2}>
                    ...
                    <ExpansionPanel className={`${'panel-plans'} ${classes.panel}`} elevation={0} onChange={(event: any, expanded: boolean) => {
                        ...
                        // @ts-ignore
                        expandedStates.forMEI = expanded;
                        this.setState(this.state);
                    }}>
                        <ExpansionPanelSummary className={classes.panelSummary}>
                            <Grid container justify='center'>
                                <Icon className={`${classes.iconExpand} ${expandedStates.forMEI ? classes.expandedIcon : undefined}`}>
                                    {expandedStates.forMEI ? 'keyboard_arrow_up' : 'keyboard_arrow_down'}
                                </Icon>
                            </Grid>
                        </ExpansionPanelSummary>
                        <ExpansionPanelDetails className={classes.panelDetails}>
                ...
                <Card className={`${'flex-column-center'} ${classes.card}`} elevation={2}>
                    ...
                    <ExpansionPanel className={`${'panel-plans'} ${classes.panel}`} elevation={0} onChange={(event: any, expanded: boolean) => {
                        ...
                        // @ts-ignore
                        expandedStates.serviceCorps = expanded;
                        this.setState(this.state);
                    }}>
                        <ExpansionPanelSummary className={classes.panelSummary}>
                            <Grid container justify='center'>
                                <Icon className={`${classes.iconExpand} ${expandedStates.serviceCorps ? classes.expandedIcon : undefined}`}>
                                    {expandedStates.serviceCorps ? 'keyboard_arrow_up' : 'keyboard_arrow_down'}
                                </Icon>
                            </Grid>
                        </ExpansionPanelSummary>
                        <ExpansionPanelDetails className={classes.panelDetails}>
                            <Grid container justify='center'>
                                <Divider variant='middle' className={classes.divider}/>
                                <Typography variant='body2' className={classes.cardTextSecondary}>
                                    Nossos planos variam conforme o perfil <br/> da sua empresa, quanto a faturamento <br/>
                                    médio mensal, quantidade de sócios e <br/> se a empresa tem funcionários.
                                </Typography>
                                <Divider variant='middle' className={classes.divider}/>
                                <Typography variant='subtitle2' className={classes.cardIndicatedTitle}>
                                    Indicado Para:
                                ...
                                <Typography variant='body2' className={classes.cardIndicatedTextSecondary}>
                                    Empresas de Prestação de serviço de <br/> Tecnologia, Startups, Advogados, <br/>
                                    Atividades da Área de Saúde e <br/> Profissionais que trabalham como PJ.
                                </Typography>
                                <Divider variant='middle' className={classes.divider}/>
                                <Typography variant='subtitle2' className={classes.cardIndicatedTitleSecondary}>
                                    Incluso na Mensalidade
                ...
                <Card className={`${'flex-column-center'} ${classes.card}`} elevation={2}>
                    ...
                    <ExpansionPanel className={`${'panel-plans'} ${classes.panel}`} elevation={0} onChange={(event: any, expanded: boolean) => {
                        ...
                        // @ts-ignore
                        expandedStates.biggerCorps = expanded;
                        this.setState(this.state);
                    }}>
                        <ExpansionPanelSummary className={classes.panelSummary}>
                            <Grid container justify='center'>
                                <Icon className={`${classes.iconExpandSecondary} ${expandedStates.meiToME ? classes.expandedIcon : undefined}`}>
                                    {expandedStates.biggerCorps ? 'keyboard_arrow_up' : 'keyboard_arrow_down'}
                                </Icon>
                            </Grid>
                        </ExpansionPanelSummary>
                        <ExpansionPanelDetails className={classes.panelDetails}>
...
ExpandCardPlan.propTypes = {
    classes: PropTypes.object.isRequired,
} as any;

// @ts-ignore
export default withStyles(styles)(ExpandCardPlan);
